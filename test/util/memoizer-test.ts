...
import Memoizer from '../../src/util/memoizer';
...
describe('Memoizer Tests', () => {
  ...
  it('should normalize null and undefined properties', () => {
    let c1 = { code: 'a', system: undefined }
    let c2 = { code: 'a', system: null }

    let ic1 = immutableMemoizer.toImmutableObjectKey(c1);
    let ic2 = immutableMemoizer.toImmutableObjectKey(c2);
  ...
  it('should properly match quantities', () => {
    let q1 = new Quantity(1, 'km')
    let q2 = new Quantity(1000, 'm')
    let q3 = new Quantity(1001, 'm')

    let iq1 = immutableMemoizer.toImmutableObjectKey(q1)
    let iq2 = immutableMemoizer.toImmutableObjectKey(q2)
    let iq3 = immutableMemoizer.toImmutableObjectKey(q3)
  ...
  it('should properly match ratios', () => {
    let r1 = new Ratio(new Quantity(1, 'km'), new Quantity(1, 'h'))
    let r2 = new Ratio(new Quantity(1000, 'm'), new Quantity(60, 'min'))

    let ir1 = immutableMemoizer.toImmutableObjectKey(r1)
    let ir2 = immutableMemoizer.toImmutableObjectKey(r2)
  ...
  it('should properly match uncertainties', () => {
    ...
    // Immutable
    let id1 = immutableMemoizer.toImmutableObjectKey(d1)
    let iu1 = immutableMemoizer.toImmutableObjectKey(u1)

    Immutable.is(id1, iu1).should.be.true()

    // Dates and Datetimes
    let d2 = new Date(2000, 1, 1)
    let d3 = new DateTime(2000, 1, 1)
    let u2 = new Uncertainty(new Date(2000, 1, 1))
    let u3 = new Uncertainty(new DateTime(2000, 1, 1))
    let u4 = new Uncertainty(new Date(2000, 1, 1), new Date(2000, 1, 1))
    let u5 = new Uncertainty(new DateTime(2000, 1, 1), new DateTime(2000, 1, 1))
    let u6 = new Uncertainty(new Date(2000, 1, 1), new Date(2000, 1, 2))
    let u7 = new Uncertainty(new DateTime(2000, 1, 1), new DateTime(2000, 1, 2))
    let u8 = new Uncertainty(new Date(2000, 1, 1), new DateTime(2000, 1, 1))
    let u9 = new Uncertainty(new DateTime(2000, 1, 1, 1, 0, 0, 0, 1), new DateTime(2000, 1, 1, 1, 0, 0, 0, 1))
    let u10 = new Uncertainty(new DateTime(2000, 1, 1, 0, 0, 0, 0, 0), new DateTime(2000, 1, 1, 0, 0, 0, 0, 0))

    let id2 = immutableMemoizer.toImmutableObjectKey(d2)
    let id3 = immutableMemoizer.toImmutableObjectKey(d3)
    let iu2 = immutableMemoizer.toImmutableObjectKey(u2)
    let iu3 = immutableMemoizer.toImmutableObjectKey(u3)
    let iu4 = immutableMemoizer.toImmutableObjectKey(u4)
    let iu5 = immutableMemoizer.toImmutableObjectKey(u5)
    let iu6 = immutableMemoizer.toImmutableObjectKey(u6)
    let iu7 = immutableMemoizer.toImmutableObjectKey(u7)
    let iu8 = immutableMemoizer.toImmutableObjectKey(u8)
    let iu9 = immutableMemoizer.toImmutableObjectKey(u9)
    let iu10 = immutableMemoizer.toImmutableObjectKey(u10)
  ...
  it('should properly match primitives', () => {
    ...
    let ic1 = immutableMemoizer.toImmutableObjectKey(c1)
    let ic2 = immutableMemoizer.toImmutableObjectKey(c2)
    let ic3 = immutableMemoizer.toImmutableObjectKey(c3)
    let ic4 = immutableMemoizer.toImmutableObjectKey(c4)
    let ic5 = immutableMemoizer.toImmutableObjectKey(c5)
    let ic6 = immutableMemoizer.toImmutableObjectKey(c6)
  ...
  it('should properly match classes', () => {
    ...
    let c2 = new Code('a', 'b')
    let c3 = new Code('a', 'c')
    let c4 = new ValueSet('a', undefined, [new Code('a', 'b')])
  ...
  it('should properly match javascript dates', () => {
    let d1 = new Date(2000, 1, 1)
    let d2 = new Date(2000, 1, 1)
    let d3 = new Date(2000, 1, 1, 1)
  ...
  it('should properly match regular expressions', () => {
    let r1 = /^\d*(\.\d{1,2})?$/g
    let r2 = /^\d*(\.\d{1,2})?$/g
    let r3 = /^([0-9]{0,5}-)?[0-9]{10}$/g

    let ir1 = immutableMemoizer.toImmutableObjectKey(r1)
    let ir2 = immutableMemoizer.toImmutableObjectKey(r2)
    let ir3 = immutableMemoizer.toImmutableObjectKey(r3)
  ...
  it('should properly match functions', () => {
    ...
    let if1 = immutableMemoizer.toImmutableObjectKey(f1)
    let if2 = immutableMemoizer.toImmutableObjectKey(f2)
    let if3 = immutableMemoizer.toImmutableObjectKey(f3)
  ...
  it('should properly match Codes/Concepts/Valuesets', () => {
    let c1 = new Code('a', 'b', undefined, undefined)
    let c2 = new Concept([new Code('a', 'b', undefined, undefined)])
    let c3 = new ValueSet('', undefined, [new Code('a', 'b', undefined, undefined)])
    let c4 = 'a'
    let c5 = { code: 'a', system: 'b', display: undefined, version: undefined }
