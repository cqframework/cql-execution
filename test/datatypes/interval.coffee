...
describe 'DateTimeInterval.contains', ->
  ...
  it 'should properly handle null endpoints', ->
    ...
    should(new Interval(null,date,false,true).contains(date)).be.null()
    ...
    should(new Interval(date,null,true,false).contains(date)).be.null()
...
describe 'IntegerInterval.contains', ->
  ...
  it 'should properly handle null endpoints', ->
    ...
    should(new Interval(null,0,false,true).contains(0)).be.null()
    ...
    should(new Interval(0,null,true,false).contains(0)).be.null()
