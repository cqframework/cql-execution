...
describe('ParameterDef', function() {
  ...
  it('should work with typed list parameters', function() {
    ...
    listParam.exec(this.ctx.withParameters({ ListParameter: ['a', 'b', 'c'] })).should.eql(['a', 'b', 'c']);
  });
...
describe('CodeParameterTypes', function() {
  ...
  it('should execute to default value', function() {
    this.foo2.exec(this.ctx).should.eql(new Code('FooTest', 'http://footest.org', undefined, 'Foo Test'));
  });
...
describe('ConceptParameterTypes', function() {
  ...
  it('should execute to default value', function() {
    this.foo2.exec(this.ctx).should.eql(new Concept([new Code('FooTest', 'http://footest.org')], 'Foo Test'));
  });
...
describe('ListParameterTypes', function() {
  ...
  it('should execute to provided valid value', function() {
    this.foo.exec(this.ctx.withParameters({ FooP: ['Hello', 'World'] })).should.eql(['Hello', 'World']);
  });

  it('should throw when provided value is not a list', function() {
    should(() => this.foo.exec(this.ctx.withParameters({ FooP: 'Hello World' }))).throw(/.*wrong type.*/);
  });

  it('should throw when list contains a wrong type', function() {
    should(() => this.foo.exec(this.ctx.withParameters({ FooP: ['Hello', 2468] }))).throw(/.*wrong type.*/);
  });
  ...
  it('should execute to overriding valid value', function() {
    this.foo2.exec(this.ctx.withParameters({ FooDP: ['Hello', 'World'] })).should.eql(['Hello', 'World']);
  });

  it('should throw when overriding value is not a list', function() {
    should(() => this.foo2.exec(this.ctx.withParameters({ FooP: 'Hello World' }))).throw(/.*wrong type.*/);
  });

  it('should throw when overriding list contains a wrong type', function() {
    should(() => this.foo2.exec(this.ctx.withParameters({ FooP: ['Hello', 2468] }))).throw(/.*wrong type.*/);
  });
});
...
describe('IntervalParameterTypes', function() {
  ...
  it('should execute to provided valid value', function() {
    this.foo.exec(this.ctx.withParameters({ FooP: new Interval(1, 5) })).should.eql(new Interval(1, 5));
  });
  ...
  it('should throw when interval contains a wrong point type', function() {
    should(() => this.foo.exec(this.ctx.withParameters({ FooP: new Interval(1.5, 5.5) }))).throw(/.*wrong type.*/);
  });
  ...
  it('should execute to overriding valid value', function() {
    this.foo2.exec(this.ctx.withParameters({ FooDP: new Interval(1, 5) })).should.eql(new Interval(1, 5));
  });
  ...
  it('should throw when overriding interval contains a wrong point type', function() {
    should(() => this.foo2.exec(this.ctx.withParameters({ FooP: new Interval(1.5, 5.5) }))).throw(/.*wrong type.*/);
  });
});
...
describe('TupleParameterTypes', function() {
  ...
  it('should throw when tuple contains a wrong property type', function() {
    should(() => this.foo.exec(this.ctx.withParameters({ FooP: { Hello: 'World', MeaningOfLife: 'Forty-Two' } }))).throw(/.*wrong type.*/);
  });
  ...
  it('should throw when overriding tuple contains a wrong property type', function() {
    should(() => this.foo2.exec(this.ctx.withParameters({ FooP: { Hello: 'World', MeaningOfLife: 'Forty-Two' } }))).throw(/.*wrong type.*/);
  });
});
