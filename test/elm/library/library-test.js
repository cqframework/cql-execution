...
describe('Using CommonLib', function() {
  ...
  it('should find the code defined in the included library', function() {
    ...
    equivalent(this.supportLibCode.exec(this.ctx), new Code('428371000124100', '2.16.840.1.113883.6.96', 'foo', 'directReferenceCode')).should.be.true();
  });
});
...
describe('Using CommonLib2', function() {
  ...
  it('should execute function from included library that uses expression', function() {
    this.exprSortsOnFunc.exec(this.ctx).should.eql([{N: 1}, {N: 2}, {N: 3}, {N: 4}, {N: 5}]);
  });
});
