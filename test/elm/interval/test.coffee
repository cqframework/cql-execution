...
describe 'Contains', ->
  ...
  it 'should correctly handle null endpoints (int)', ->
    ...
    should(@unknownBegContainsInt.exec(@ctx)).be.null()
    ...
    should(@unknownEndContainsInt.exec(@ctx)).be.null()
  ...
  it 'should correctly handle null endpoints (date)', ->
    ...
    should(@unknownBegContainsDate.exec(@ctx)).be.null()
    ...
    should(@unknownEndContainsDate.exec(@ctx)).be.null()
  ...
  it 'should correctly handle imprecision', ->
    ...
    should(@notContainsImpreciseDate.exec(@ctx)).be.null()
  ...
  it 'should correctly compare using the requested precision', ->
    ...
    @containsDayOfDateHighEdge.exec(@ctx).should.be.false()
    ...
    @containsDayOfDateImpreciseHighEdge.exec(@ctx).should.be.false()
