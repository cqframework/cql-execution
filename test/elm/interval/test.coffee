...
describe 'Contains', ->
  ...
  it 'should correctly handle null endpoints (int)', ->
    ...
    should(@unknownOpenBegMayContainInt.exec(@ctx)).be.null()
    ...
    should(@unknownOpenEndMayContainInt.exec(@ctx)).be.null()
  ...
  it 'should correctly handle null endpoints (date)', ->
    ...
    should(@unknownOpenEndMayContainDate.exec(@ctx)).be.null()
