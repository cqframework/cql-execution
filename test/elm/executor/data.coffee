...
###
Translation Error(s):
[13:1, 13:18] Could not resolve context name Population in model QUICK.
###
module.exports['Age'] = {
   "library" : {
      "annotation" : [ {
         ...
         "endLine" : 13,
         "endChar" : 18,
         "message" : "Could not resolve context name Population in model QUICK.",
         "errorType" : "semantic",
         "errorSeverity" : "error",
         "type" : "CqlToElmError"
      }, {
         ...
         "endLine" : 17,
         "endChar" : 50,
         "message" : "Boolean-valued expression was promoted to a list.",
         "errorType" : "semantic",
